...
public class TodosAlunos extends javax.swing.JDialog {
        ...
        panBuscarLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panBuscarLayout.createSequentialGroup()
                ...
                .addGroup(panBuscarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cbbCurso, 0, 293, Short.MAX_VALUE))
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(panBuscarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(edtCpf, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblCpf))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panBuscarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (retorno == -1) {
            ...
            String message = "Deseja realmente ecluir este aluno ?";
            ...
            if (reply != JOptionPane.YES_OPTION) {
                JOptionPane.showMessageDialog(null, ALUNO_NAO_EXCLUIDO);
                return;
            }

            try {
                if (Aluno.buscarPorId(retorno) == null) {
                    JOptionPane.showMessageDialog(null, ALUNO_NAO_EXISTE);
                    return;
                }
            } catch (SQLException ex) {
                Logger.getLogger(TodosAlunos.class.getName()).log(Level.SEVERE, null, ex);
            ...
            try {
                if (Aluno.buscarPorTotalContrato(retorno).getTotalContratos() > 0) {
                    JOptionPane.showMessageDialog(null, ALUNO_CONTRATO_EXISTENTE_EXCLUSAO);
                    return;
                }
            } catch (SQLException ex) {
                Logger.getLogger(TodosAlunos.class.getName()).log(Level.SEVERE, null, ex);
            ...
            try {
                a.excluir(retorno);
                JOptionPane.showMessageDialog(null, ALUNO_EXCLUIDO);
            } catch (SQLException ex) {
                Logger.getLogger(TodosAlunos.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(null, ex.getMessage());
            }
